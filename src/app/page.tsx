  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white selection:bg-blue-500/30 scroll-smooth flex flex-col">
      ...
      <nav className="fixed top-0 w-full z-[100] border-b border-white/5 bg-slate-950/90 backdrop-blur-md">
        ...
        {/* MENÚ MÓVIL (Overlay Opaco) */}
        <div className={`fixed inset-0 bg-slate-950 z-[105] transition-opacity duration-500 ${isMenuOpen ? 'opacity-100 visible' : 'opacity-0 invisible'} md:hidden`}>
          <div className="flex flex-col items-center justify-center h-full gap-10 text-center">
            <a href="#inicio" onClick={() => setIsMenuOpen(false)} className="text-4xl font-black tracking-tighter hover:text-blue-500 transition-colors uppercase">Inicio</a>
            <a href="#servicios" onClick={() => setIsMenuOpen(false)} className="text-4xl font-black tracking-tighter hover:text-blue-500 transition-colors uppercase">Servicios</a>
            <a href="#proyectos" onClick={() => setIsMenuOpen(false)} className="text-4xl font-black tracking-tighter hover:text-blue-500 transition-colors uppercase">Proyectos</a>
            <Link href="/sobre-mi" onClick={() => setIsMenuOpen(false)} className="text-4xl font-black tracking-tighter hover:text-blue-500 transition-colors uppercase">Sobre Mi</Link>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="pt-8 border-t border-white/5">
              ...
              <div className="flex flex-wrap justify-center items-center gap-6 md:gap-12 opacity-40 hover:opacity-100 transition-opacity duration-500">
                ...
                <span className="text-[10px] md:text-xs font-black tracking-tighter text-blue-400 font-bold">SUPABASE</span>
